...
function sqlite3_open(dbname: PChar; var db: TSqliteDB): integer; cdecl; external;
function sqlite3_close(db: TSQLiteDB): integer; cdecl; external;
function sqlite3_exec(db: TSQLiteDB; SQLStatement: PChar; Callback: TSQLite3_Callback; Sender: Pointer; var ErrMsg: PChar): integer; cdecl; external;
function sqlite3_libversion(): PChar; cdecl; external;
function sqlite3_errmsg(db: TSQLiteDB): PChar; cdecl; external;
function sqlite3_errcode(db: TSQLiteDB): integer; cdecl; external;
procedure sqlite3_free(P: PChar); cdecl; external;
function sqlite3_get_table(db: TSQLiteDB; SQLStatement: PChar; var ResultPtr: TSQLiteResult; var RowCount: Cardinal; var ColCount: Cardinal; var ErrMsg: PChar): integer; cdecl; external;
procedure sqlite3_free_table(Table: TSQLiteResult); cdecl; external;
function sqlite3_complete(P: PChar): boolean; cdecl; external;
function sqlite3_last_insert_rowid(db: TSQLiteDB): int64; cdecl; external;
procedure sqlite3_interrupt(db: TSQLiteDB); cdecl; external;
procedure sqlite3_busy_handler(db: TSQLiteDB; CallbackPtr: Pointer; Sender: TObject); cdecl; external;
procedure sqlite3_busy_timeout(db: TSQLiteDB; TimeOut: integer); cdecl; external;
function sqlite3_changes(db: TSQLiteDB): integer; cdecl; external;
function sqlite3_total_changes(db: TSQLiteDB): integer; cdecl; external;
function sqlite3_prepare(db: TSQLiteDB; SQLStatement: PChar; nBytes: integer; var hStmt: TSqliteStmt; var pzTail: PChar): integer; cdecl; external;
function sqlite3_column_count(hStmt: TSqliteStmt): integer; cdecl; external;
function sqlite3_column_name(hStmt: TSqliteStmt; ColNum: integer): pchar; cdecl; external;
function sqlite3_column_decltype(hStmt: TSqliteStmt; ColNum: integer): pchar; cdecl; external;
function sqlite3_step(hStmt: TSqliteStmt): integer; cdecl; external;
function sqlite3_data_count(hStmt: TSqliteStmt): integer; cdecl; external;

function sqlite3_column_blob(hStmt: TSqliteStmt; ColNum: integer): pointer; cdecl; external;
function sqlite3_column_bytes(hStmt: TSqliteStmt; ColNum: integer): integer; cdecl; external;
function sqlite3_column_double(hStmt: TSqliteStmt; ColNum: integer): double; cdecl; external;
function sqlite3_column_int(hStmt: TSqliteStmt; ColNum: integer): integer; cdecl; external;
function sqlite3_column_text(hStmt: TSqliteStmt; ColNum: integer): pchar; cdecl; external;
function sqlite3_column_type(hStmt: TSqliteStmt; ColNum: integer): integer; cdecl; external;
function sqlite3_column_int64(hStmt: TSqliteStmt; ColNum: integer): Int64; cdecl; external;
function sqlite3_finalize(hStmt: TSqliteStmt): integer; cdecl; external;
function sqlite3_reset(hStmt: TSqliteStmt): integer; cdecl; external;
